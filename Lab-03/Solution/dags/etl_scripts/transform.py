...
def transform_data(source_csv, target_dir):
    ...
    animal_dim.to_csv(target_dir + '/dim_animal.csv', index = False)
    outcometype_dim.to_csv(target_dir + '/dim_outcometype.csv', index = False)
    outcomesubtype_dim.to_csv(target_dir + '/dim_outcomesubtype.csv', index =False)
    processed_dim.to_csv(target_dir + '/dim_processed.csv', index = False)
    repro_dim.to_csv(target_dir + '/dim_repro.csv', index = False)

    df_fact.to_csv(target_dir + '/fct_outcomes.csv', index = False)
